...
def save_data(saved_data: Callable[[str],int], archive_type: str, id_number: str) -> None:
...
def show_digimon_trivia(digimon_info: str, id_number: str) -> None:
    ...
    msg += (" " * 4) + "> " + digimon_info["total_trivia"] + " digimon" + \
...
def show_info(process_pokemons: Callable[[str],Dict], id_number: str) -> None: 
    ...
    msg += "|" + ("-" * 18) + "|" + ("-" * 29) + "|" + ("-" * 29) + "|\n"
    msg += "|Pokemons" + (" " * 10) + "| " + process_pokemons["player1_total_pokemons_info"] + \
    ...
    msg += "|Legendary" + (" " * 7) + "| " + process_pokemons["legendary_player1_info"] + \
